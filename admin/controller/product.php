                    ...
                    <table border="1" align="center" cellpadding="10" style="width:100%">
                        ...
                        while ($row = mysqli_fetch_assoc($data1)) {
                            ...
                            <tr data-expanded="true">
                                ...
                                <td align="center">
                                    <a onclick='javascript:deleletconfig();return false;' href="DeleteProduct.php?m=post&productId=<?php echo $row['productId'];
                                    ?>">
...
<script>
    function deleletconfig() {
        ...
        var del = confirm("Bạn chắc chắn xóa sản phẩm này?");
        if (del == true) {
